...
static const auto REG_ENVI_SUB_KEY =
...
UINT reg_edit::AddMARE_DIRToEnvironmentPath()
{
...
UINT reg_edit::RemoveMARE_DIRFromEnvironmentPath()
{
	//Get the %MARE_DIR% value from the registry.
	TCHAR* regMAREDirValueData = nullptr;
	DWORD regMAREDirValueType;
...
UINT reg_edit::CreateMARE_DIRKey(const TCHAR* mareDir, DWORD mareDirLen)
{
...
UINT reg_edit::RemoveMARE_DIRKey()
{
	//Open the environment sub key
	HKEY enviKey;
	auto regRes = RegOpenKeyEx(HKEY_LOCAL_MACHINE, REG_ENVI_SUB_KEY, 0, KEY_WRITE, &enviKey);
...
UINT reg_edit::GetMAREDirValueFromReg(TCHAR** value_p,
...
UINT reg_edit::GetPathValueFromReg(TCHAR** value_p,
